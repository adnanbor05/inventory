                    ...
                    while ($daftar_pesan = mysqli_fetch_array($query_daftar_pesan)){
                      ...
                      elseif ($daftar_pesan['sudah_dibaca'] == "sudah") {
                        ...
                        <tr class="pesan">
                          ...
                          <td><?php echo $daftar_pesan['tanggal']; ?></td>
                          <td class="text-center">
                            <a href="../_proses_petugas/del_chat.php?id=<?=$daftar_pesan['id_pesan']?>" onclick="return confirm('Yakin akan menghapus pesan dari <?=$daftar_pesan['nama']?> ?')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o fa-xs"></i> hapus
                            </a>
                          </td>
                        </tr>
                      <?php } ?>
      ...
      <div class="col-md-6">
        <div class="box box-primary">
          ...
          <div class="box-body" id="kirim_pesan">
            <form action="../_proses_petugas/proses_kirim_pesan.php" method="post" id="form_kirim_pesan">
              <?php 
              if (isset($_GET['pesan'])) {
                if ($_GET['pesan']){?>
