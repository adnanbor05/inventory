										...
										while ($data = mysqli_fetch_array($sql_supp)) { ?>
											<tr>
												...
												<td class="text-center">
													...
													<a href="../_proses_petugas/delSupp.php?id=<?=$data['kode_supp']?>" onclick="return confirm('Yakin akan menghapus data <?=$data['nama_supp']?> ini?')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o fa-xs"></i> Hapus</a>
												</td>
											</tr>
											<?php
										}
