								...
								while ($data = mysqli_fetch_array($sql_detBarangmsk)) { ?>
									<tr>
										...
										<td class="text-center">
											<a href="../_proses_petugas/delBarangmsk.php?id=<?=$data['id_brgmsk']?>&&kd=<?=$data['kode_barang']?>" onclick="return confirm('Yakin akan menghapus data <?=$data['nama_barang']?> ini?')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o fa-xs"></i></a>
										</td>
									</tr>
									<?php
								}
