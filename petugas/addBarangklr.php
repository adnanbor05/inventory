			...
			<div class="col-lg-12" >
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<form action="../_proses_petugas/proses_barangklr.php" method="post" style="margin-top: 20px; margin-bottom: 20px;" id="myform" onSubmit="return validasi()" name="formbarangkeluar">
