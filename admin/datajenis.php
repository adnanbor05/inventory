										...
										while ($data = mysqli_fetch_array($sql_jenis)) { ?>
											<tr>
												...
												<td class="text-center">
													<a href="../_proses/dellJenis.php?id=<?=$data['kode_jenis']?>" onclick="return confirm('Yakin akan menghapus data jenis kopi <?=$data['nama_jenis']?> ?')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o fa-xs"></i> Hapus</a>
												</td>
											</tr>
											<?php
										}
