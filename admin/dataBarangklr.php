										...
										while ($data = mysqli_fetch_array($sql_barang)) { ?>
											<tr>
												...
												<td class="text-center">
													...
													<a href="../_proses/delBarangklr.php?id=<?=$data['id_brgklr']?>" onclick="return confirm('Yakin akan menghapus data <?=$data['nama_barang']?> ini?')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o fa-xs"></i> Hapus</a>
												</td>
											</tr>
											<?php
										}
