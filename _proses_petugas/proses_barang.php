...
if (isset($_POST['tambah'])){
	...
	if (mysqli_num_rows($sql_cek_kodebrg) > 0) {
		// echo "<script>alert('Kode Supplier sudah pernah di input!');  window.location='../petugas/dataSupp.php'</script>";
		echo "<script>window.location='../petugas/addBarang.php?pesan=gagal'</script>";
	} else {
		...
		echo "<script>window.location='../petugas/dataBarang.php'</script>";
	}
